...
--
-- Host: 127.0.0.1
-- Generation Time: May 25, 2026 at 05:21 AM
...
(1, 'Academic Writing', 'academic-writing', '📝', 'Essays, reports, research papers'),
(2, 'Programming & Tech', 'programming', '💻', 'Coding, web dev, apps'),
(3, 'Design & Creative', 'design', '🎨', 'Logos, posters, UI/UX'),
(4, 'Tutoring', 'tutoring', '📚', 'Subject tutoring and coaching'),
(5, 'Translation', 'translation', '🌐', 'Language translation services'),
(6, 'Video & Animation', 'video', '🎬', 'Video editing and animation'),
(7, 'Data & Research', 'data', '📊', 'Data analysis and research'),
(8, 'Other Services', 'other', '⚡', 'Any other campus services');
...
(6, 4, 2, 'yctvtvy', 'ctcyvyugyfyrdrfyuutc6', 300000.00, 3, NULL, 'active', 0, '2026-05-14 20:08:25', '2026-05-14 20:08:25'),
